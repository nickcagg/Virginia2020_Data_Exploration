...
INPUT_FILE = DIR / "strd_data" / "OCCUPATION_DATA.csv"   # ← replace with your file path

CLUSTER_RESULTS = DIR / "clustering" / "occupation"
...
TOTAL_COL = "Total Employed Civillians Above 16"
